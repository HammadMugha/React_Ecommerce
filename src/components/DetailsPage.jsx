...
export default function DetailsPage() {
  ...
  const handleClick = (e,item)=>{
    ...
    toast.success(`${item.title} addedd successfuly`)
...
useEffect(()=>{
  ...
  //JO PRODUCT SHOW KYA HA USSE RELATED PRODUCTS
  const relatedProducts = ProductsData.filter(
    (ite) => ite.category === data.category
  );
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-[980px] mx-auto items-center">
    ...
    <img src={data.image}
      ...
      <div className="w-full mt-6 lg:mt-0">
        ...
        <div className="flex">
          ...
          <button className="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded" onClick={(e) => {handleClick(e,data)}}>Basket</button>
    ...
    <Products items={related.slice(0,4)} title={"Related Products"} />
    </div>
  </div>
  {/* <Toaster /> */}
  <ToastContainer
